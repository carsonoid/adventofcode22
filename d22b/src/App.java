    ...
    public static void main(String[] args) throws Exception {
        ...
        for (var move : moves) {
            ...
            for (int numMoved = 0; numMoved < move.Distance;) {
                var next = grid.GetAdjacentWithCubicWrap(possible.x, possible.y, facing);
                ...
                // some moves may have caused a wrap and changed the direction being faced
                if (next.dirChange != ' ') {
                    facing = next.dirChange;
                    System.out.println("Now facing " + facing);
                }
            }
        }
