...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // // dumb manual add of stacks
        // stacks.add(new Stack(Arrays.asList('N', 'Z')));
        // stacks.add(new Stack(Arrays.asList('D', 'C', 'M')));
        // stacks.add(new Stack(Arrays.asList('P')));
